...
<img src="https://pasteboard.co/TCYYMyey55kM.png" alt="imgur" width=600/>
...
#### Mechanism to remove the userland rootkit

INFINITE has implemented a mechanism that requires the user's help to remove the userland rootkit.It shows all the .so files that are preset for the user and asks them to check if there are any others in order to remove them later.
...
**ModTracer** ~ Created by MatheuzSecurity: https://github.com/MatheuZSecurity
Repository to the tool: https://github.com/MatheuZSecurity/ModTracer
